...
synthesis_field_cmap_name={'DBZ':'nipy_spectral','U':'Accent','V':'Accent','WVA':'PRGn','WUP':'PRGn','VOR':'PuOr','CON':'RdBu_r','SPD':'jet'}
synthesis_field_cmap_range={'DBZ':[0,40],'U':[-20,20],'V':[-10,30],'WVA':[-2,2],'WUP':[-2,2],'VOR':[-1,1],'CON':[-1,1],'SPD':[0,18]}
